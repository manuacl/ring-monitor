...
Window {
    ...
    readonly property var _bridgeMap: [
        ...
        // AppearanceBody
        [appearanceBody, "orientation", "orientation"], [appearanceBody, "ringSize", "ringSize"], [appearanceBody, "ringSpacingPercent", "ringSpacingPercent"], [appearanceBody, "windowAnchorCorner", "windowAnchorCorner"], [appearanceBody, "windowMarginX", "windowMarginX"], [appearanceBody, "windowMarginY", "windowMarginY"], [appearanceBody, "windowScreen", "windowScreen"], [appearanceBody, "textOpacity", "textOpacity"], [appearanceBody, "trackOpacity", "trackOpacity"], [appearanceBody, "arcOpacity", "arcOpacity"], [appearanceBody, "colorTheme", "colorTheme"], [appearanceBody, "colorMode", "colorMode"], [appearanceBody, "customColorLight", "customColorLight"], [appearanceBody, "customColorDark", "customColorDark"], [appearanceBody, "textColorMode", "textColorMode"], [appearanceBody, "customTextColorLight", "customTextColorLight"], [appearanceBody, "customTextColorDark", "customTextColorDark"], [appearanceBody, "backgroundEnabled", "backgroundEnabled"], [appearanceBody, "backgroundColor", "backgroundColor"], [appearanceBody, "backgroundOpacity", "backgroundOpacity"], [appearanceBody, "backgroundSpread", "backgroundSpread"], [appearanceBody, "backgroundEdgeSoftness", "backgroundEdgeSoftness"]]
