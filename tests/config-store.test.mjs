...
// new config entry.
const EXPECTED_KEYS = ["metricOrder", "enabledMetrics", "showCpuCores", "mergeCpuTemp", "mergeGpuTemp", "orientation", "textOpacity", "trackOpacity", "arcOpacity", "colorTheme", "colorMode", "customColorLight", "customColorDark", "tempUnit"];
