...
// new config entry.
const EXPECTED_KEYS = ["metricOrder", "enabledMetrics", "showCpuCores", "orientation", "textOpacity", "trackOpacity", "arcOpacity", "colorTheme", "colorMode", "customColorLight", "customColorDark"];
