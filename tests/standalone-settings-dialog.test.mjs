...
const BRIDGED_KEYS = [
    ...
    ["tempUnit", "tempUnit"],
    ["sensorTempId", "sensorTempId"],
    ["sensorTempLabel", "sensorTempLabel"],
    ["sensorTempMinC", "sensorTempMinC"],
    ["sensorTempMaxC", "sensorTempMaxC"],
    ["cpuTempMinC", "cpuTempMinC"],
    ["cpuTempMaxC", "cpuTempMaxC"],
    ["gpuTempMinC", "gpuTempMinC"],
    ["gpuTempMaxC", "gpuTempMaxC"],
